...
public class LottoTicketGenerator {
    ...
    public static LottoTickets createAutoTickets(final NumberOfTickets numberOfTickets) {
        return new LottoTickets(IntStream.range(0, numberOfTickets.getNumberOfTickets())
